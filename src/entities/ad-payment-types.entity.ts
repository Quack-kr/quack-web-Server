...
export class AdPaymentTypes {
  ...
  @Column({ name: 'keyword', type: 'varchar', length: 255, unique: true })
  keyword: string;
  ...
  @Column({ name: 'discount_rate', type: 'varchar', length: 100 })
  discountRate: string;
  ...
  @Column({ name: 'top_text', type: 'varchar', length: 255 })
  topText: string;

  @Column({ name: 'bottom_text', type: 'varchar', length: 255 })
  bottomText: string;
